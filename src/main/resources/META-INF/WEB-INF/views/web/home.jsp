            ...
            <tr class="align-middle">
                ...
                <td class="text-center">
                    <button class="btn btn-sm btn-info"
                            data-bs-toggle="modal" data-bs-target="#viewModal${c.categoryId}">
                        Xem
                    </button>
                </td>
            </tr>
              ...
              <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <p><strong>Tên:</strong> ${c.categoryName}</p>
                    <p><strong>Ảnh:</strong><br>
                        <img src="${pageContext.request.contextPath}/image/${c.images}" class="img-fluid rounded shadow-sm">
                    </p>

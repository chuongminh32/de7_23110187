...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <!-- Ô tìm kiếm -->
        <form class="d-flex" method="get" action="${pageContext.request.contextPath}/admin/user/list">
            <input class="form-control me-2" type="search" name="keyword" placeholder="Tìm theo username"
                   value="${keyword}">
